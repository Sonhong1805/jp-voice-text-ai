...
class ASRService:
    def __init__(self):
        ...
        checkpoint_path = os.path.join(os.path.dirname(__file__), "..", "models", "checkpoints", "best-medium-ep5-inference.pt")
        
        print(f"Loading Dual CTC Model from {checkpoint_path}...")
        self.model = load_checkpoint(checkpoint_path, pretrained="reazon-research/japanese-wav2vec2-large", inter_ctc_layer=12)
